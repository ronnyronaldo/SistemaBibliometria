...
class ReferenciaCorrectaScopus(db.Model):
    ...
    articulosReferencia = db.relationship(ArticuloReferenciaScopus, foreign_keys="ReferenciaCorrectaScopus.id_articleRef")
    ...
    def __init__(self, id_articleRef , id_ReferenciaAux, container_type, source, filled, gsrank, pub_url, author_id, num_citations, url_scholarbib, url_add_sclib, citedby_url, url_related_articles, title, author, pub_year, venue, abstract):
      self.id_articleRef  = id_articleRef 
      self.id_ReferenciaAux  = id_ReferenciaAux
