...
def insertarAutor(nuevoAutor):
    resultado_base_datos_digital = validarBaseDatosDigitalPorNombre(nuevoAutor['nombre_base_datos_digital'])
    ...
    if numeroBaseDatosDigital == 1:
        ...
        articulo = obtenerIdArticuloIngresarAutor(nuevoAutor['titulo'], nuevoAutor['titulo_alternativo'], nuevoAutor['anio_publicacion'], id_base_datos_digital)
